    ...
    return (
        <div flex>
            ...
            <div class="flex justify-center">
                ...
                <div class="col-span-2 grid-rows-2 mr-3">

                    <figure class="relative w-full transition-all duration-300 cursor-pointer filter h-50 row-span-1 mb-3">
                    <a href="#">
                        <img class="h-full" src="https://www.allrecipes.com/thmb/5JVfA7MxfTUPfRerQMdF-nGKsLY=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/25473-the-perfect-basic-burger-DDMFS-4x3-56eaba3833fd4a26a82755bcd0be0c54.jpg" alt="image description"/>
                    </a>
                ...
                <figure class="relative max-w-sm transition-all duration-300 cursor-pointer filter ml-1 h-full w-full col-span-3">
                <a href="#">
                ...
                <figcaption class="absolute px-4 text-lg text-black bottom-5 right-5 bg-white ml-3">
