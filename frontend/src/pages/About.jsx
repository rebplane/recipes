...
function About() {
  return (
    <div>
        <Header/>
            <div className="h-screen flex flex-col mt-20 ml-20 md:mb-0 mb-96">
                <div className="md:flex">
                        <img src="/images/rebbychay.png" class="md:mt-36 md:h-3/4 h-96 w-96 border border-black" alt="RebbyChayLogo" />
                    <div className="md:ml-20">
                        ...
                        <p className="text-2xl mt-10 md:w-1/2">Growing up with both Chinese and Greek backgrounds, we have both eaten a wide variety of food over the years. With one of us being lactose intolerant, and previously needing to be on a FODMAP diet, we are very aware of food intolerances and how they can affect people, and make eating and cooking feel hopeless.</p>
